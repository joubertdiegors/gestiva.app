...
urlpatterns = [
    ...
    path('board/vehicles/', views.board_vehicles_search, name='board_vehicles_search'),
    path('board/vehicles/assign/', views.board_assign_vehicle, name='board_assign_vehicle'),
    path('board/vehicles/driver/', views.board_set_vehicle_driver, name='board_set_vehicle_driver'),
